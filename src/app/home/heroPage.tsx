  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-8 lg:p-12 bg-black">
      <div className="grid">
        ...
        <div className="blur">
          <Avatar src="./images/myimage.png" className="w-80 h-80 avatar" />
        </div>
      </div>
      <div className="flex gap-4 para">
        <p>Hi !</p>
        <p>
          Wel<strong className="text-white"> come</strong>
        </p>
      </div>
      <div className="flex gap-4 introbox">
      ...
      <Link href="#about" className="button sec">
